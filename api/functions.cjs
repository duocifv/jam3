...
async function deploy() {
  try {
    ...
    const localDir = path.join(process.cwd(), 'functions') // Đường dẫn đến thư mục src/api trong dự án
    const remoteDir = 'cms.duocnv.top/wp-content/themes/hello-elementor/includes' // Đường dẫn đến thư mục trên server
